...
public class MainDate{
	...
	public static void main(String[] args){
		...
		try{
			Date today = new Date(); //dentro se puede mater la fecha que quieras (29/3/2017)
				//today = new Date(99,13,2017);
				System.out.println(today); //tu intentas, de ahi el try, y si hay un error como 6/0, ahi entra el cath que captura el error y te lleva a la clase y de ahi te imprime el error.
